...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Task Manager - Création</title>
    ...
    <body>
        ...
        <div class="bodyLocation">Création</div>
        <c:if test="${success == true}">
            <div class="successMessage">Tâche créée avec succès</div>
        </c:if>
        <c:if test="${success == false}">
            <div class="errorMessage">Création échouée</div>
        </c:if>
        <div class="formContainer">
            <div class="formContainerTitle">Créer une nouvelle tâche</div>
            <form action="/creation" method="post">
                <label class="formContainerLabel">Nom :</label>
                <input name="taskName" class="formContainerInput" type="text" placeholder="Nom de la tâche" required />
                <label class="formContainerLabel">Description :</label>
                <textarea class="formContainerInput" rows="6" maxlength="1024" placeholder="Détail de la tâche" name="taskDescription" required></textarea>
                ...
                <input class="formContainerUrgencyCheckbox" type="checkbox" name="taskUrgency" />
